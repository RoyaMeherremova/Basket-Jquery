...
cardBtns.forEach(btn => {
    btn.addEventListener("click", function (e) {
        ...
        if (existProduct != undefined) {
            ...
            existProduct.price=productPrice*existProduct.count     //eyer localstoragede hemin product varsa onun  qiymetini beraber ele oz ezel giymeti vurulusun productun countuna 
